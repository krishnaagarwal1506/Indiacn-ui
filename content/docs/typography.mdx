...
<ComponentSource
  collapsible={false}
  code={`<Display1>80px Hero Title</Display1>
...
<ComponentSource
  collapsible={false}
  code={`<Headline1>40px Main Heading</Headline1>
...
<ComponentSource
  collapsible={false}
  code={`<Title1>22px List Item Title</Title1>
...
<ComponentSource
  collapsible={false}
  code={`<Label1>14px Button Label</Label1>
...
<ComponentSource
  collapsible={false}
  code={`<Body1>16px Main content text</Body1>
...
<ComponentSource
  collapsible={false}
  code={`<Headline1 className="text-center text-primary mb-4">Centered Primary Heading</Headline1>
