...
|                                                | For                                    |
| ---------------------------------------------- | -------------------------------------- |
| [Bar](/docs/bar-chart)                         | Comparing magnitudes across categories |
| [Horizontal bar](/docs/horizontal-bar-chart)   | Long labels, or a ranking              |
| [Stacked bar](/docs/stacked-bar-chart)         | A total and its composition            |
| [Line](/docs/line-chart)                       | A value over time, or against a target |
| [Multi-axis line](/docs/multi-axis-line-chart) | Two series in different units          |
| [Pie](/docs/pie-chart)                         | Rough shares of one whole              |
| [Doughnut](/docs/doughnut-chart)               | Shares, with a total in the middle     |
| [Polar area](/docs/polar-area-chart)           | Cyclical categories on a shared radius |
| [Radar](/docs/radar-chart)                     | One subject across several dimensions  |
| [Scatter](/docs/scatter-chart)                 | The relationship between two variables |
| [Bubble](/docs/bubble-chart)                   | Two positions and a size               |
