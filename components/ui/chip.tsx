...
const CHIP_VARIANTS = cva(
  'inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-neutral-200 bg-neutral-0 px-3 py-1.5 text-sm font-normal text-neutral transition-all hover:bg-[#FAEFFF] hover:shadow-xs active:shadow-none dark:border-neutral-700 dark:bg-neutral-900 dark:hover:bg-primary-50',
  {
    variants: {
      variant: {
        outlined: '',
