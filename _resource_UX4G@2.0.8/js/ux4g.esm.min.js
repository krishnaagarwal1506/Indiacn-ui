...
class Offcanvas extends BaseComponent {
  ...
  show(e) {
    ...
    if (EventHandler.trigger(this._element, EVENT_SHOW$3, { relatedTarget: e }).defaultPrevented)
      return;
    ((this._isShown = !0),
      this._backdrop.show(),
...
class Tooltip extends BaseComponent {
  ...
  hide() {
    if (!this._isShown()) return;
    if (EventHandler.trigger(this._element, this.constructor.eventName('hide')).defaultPrevented)
      return;
    if (
