...
!(function (t, e) {
  if ('function' == typeof define && define.amd)
    ...
    var i =
      'undefined' != typeof window && void 0 !== window.moment ? window.moment : require('moment');
      ...
      updateCalendars: function () {
        if (this.timePicker) {
          ...
          if (this.endDate) {
            ...
            isNaN(e) &&
              (e = parseInt(this.container.find('.right .minuteselect option:last').val(), 10)),
            (a = this.timePickerSeconds
        ...
        if ('right' != t || this.endDate) {
          ...
          if (
            ...
            if (
              ...
              a.minute(
                isNaN(a.minute()) ? n.find('.minuteselect option:selected').val() : a.minute(),
              ),
              a.second(
                isNaN(a.second()) ? n.find('.secondselect option:selected').val() : a.second(),
              ),
              !this.timePicker24Hour)
            ) {
