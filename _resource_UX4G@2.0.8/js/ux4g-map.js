!(
   ...
   */ (function (t, e) {
    ...
    (() => {
      ...
      ((T.d = (t, e) => {
        for (var i in e)
          T.o(e, i) && !T.o(t, i) && Object.defineProperty(t, i, { enumerable: !0, get: e[i] });
      }),
    ...
    - ${i}: ${e}`),
        ...
        (q(A, 'displayError', { chart: i, code: t, message: a, params: s }, function () {
          if (e) throw Error(a);
      ...
      O.jQuery &&
        (O.jQuery.fn.UX4Gmap = function () {
          ...
          if (this[0])
            return t[0]
              ? (new A[D(t[0]) ? t.shift() : 'Chart'](this[0], t[0], t[1]), this)
      ...
      let J = {
          ...
          getNestedProperty: function (t, e) {
            ...
            for (; i.length && j(e); ) {
              ...
              let s = e[t.replace(/[\\'"]/g, '')];
              if (!j(s) || 'function' == typeof s || 'number' == typeof s.nodeType || s === O)
                return;
              e = s;
            }
            return e;
              ...
              r = function (t, e) {
                return (
                  ...
                  $(e, function (i, s) {
                    '__proto__' !== s &&
                      'constructor' !== s &&
                      (!z(i, !0) || R(i) || N(i) ? (t[s] = e[s]) : (t[s] = r(t[s] || {}, i)));
                  }),
                  t
                );
              };
            ...
            if (!o) {
              ...
              try {
                ...
                /Invalid time zone/i.test(e.message)
                  ? (ti(34), (t.timeZone = 'UTC'), (o = new Intl.DateTimeFormat(i, t)))
                  : ti(e.message, !1);
              }
            }
          ...
          makeTime(t, e, i = 1, s = 0, o, r, a) {
            ...
            if ('UTC' !== this.timezone) {
              ...
              if (((n += t), -1 !== [2, 3, 8, 9, 10, 11].indexOf(e) && (s < 5 || s > 20))) {
                ...
                t !== e
                  ? (n += e - t)
                  : t - 36e5 !== this.getTimezoneOffset(n - 36e5) || tu || (n -= 36e5);
              }
            }
            return n;
          }
          ...
          getTimeTicks(t, e, i, s) {
            ...
            if ((s ?? (s = 1), te(e))) {
              if (
                ...
                l >= tc.second && (g = l >= tc.minute ? 0 : n * Math.floor(g / n)),
                l >= tc.minute && (u = l >= tc.hour ? 0 : n * Math.floor(u / n)),
                l >= tc.hour && (p = l >= tc.day ? 0 : n * Math.floor(p / n)),
                l >= tc.day && (c = l >= tc.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                ...
                let t = tm(
                  this.dateTimeFormat({ timeZone: this.timezone, weekday: 'narrow' }, e, 'es'),
                );
                c += -t + s + (t < s ? -7 : 0);
              }
              ((e = o.makeTime(h, d, c, p, u, g, m)),
                o.variableTimezone &&
                  te(i) &&
                  (f = i - e > 4 * tc.month || o.getTimezoneOffset(e) !== o.getTimezoneOffset(i)));
              let t = e,
                x = 1;
              for (; t < i; )
                (r.push(t),
                  l === tc.year
                    ...
                    : l === tc.month
                      ...
                      : f && (l === tc.day || l === tc.week)
                        ? (t = o.makeTime(h, d, c + x * n * (l === tc.day ? 1 : 7)))
                        : f && l === tc.hour && n > 1
        ...
        tw = {
          ...
          setOptions: function (t) {
            return (
              ...
              t.lang && 'locale' in t.lang && tM.update({ locale: t.lang.locale }),
              tv
            );
          },
        },
      ...
      class tA {
        ...
        constructor(t) {
          ...
          if ('object' == typeof t && void 0 !== t.stops)
            ...
            for (
              this.input = t = tA.names[t.toLowerCase()] || t, s = tA.parsers.length;
              s-- && !i;
      ...
      class tI {
        ...
        initPath(t, e, i) {
          ...
          return (
            u.length && tO(h) && ((d = r.length + h * n), p ? (g(u, r), m(r)) : (g(r, u), m(u))),
            [u, r]
          );
        }
        fillSetter() {
      ...
      function tG(t) {
        return tR(t) ? tW({ duration: 500, defer: 0 }, t) : { duration: t ? 500 : 0, defer: 0 };
      }
      function tF(t, e) {
        let i = tI.timers.length;
        for (; i--; )
          tI.timers[i].elem !== t || (e && e !== tI.timers[i].prop) || (tI.timers[i].stopped = !0);
      }
      let tH = {
          animate: function (t, e, i) {
            let s,
              ...
              a,
              n;
            (tR(i) || ((n = arguments), (i = { duration: n[2], easing: n[3], complete: n[4] })),
              ...
              tj(e, function (n, l) {
                (tF(t, l),
                  ...
                  'd' === l && tz(e.d)
                    ...
                    : t.attr
                      ? (s = t.attr(l))
                      : ((s = parseFloat(tB(t, l)) || 0), 'opacity' !== l && (o = 'px')),
                  r || (r = n),
          ...
          getDeferredAnimation: function (t, e, i) {
            ...
            return (
              o.forEach(t => {
                ...
                ((r = tR(e) && tD(e.defer) ? s.defer : Math.max(r, i.duration + i.defer)),
        ...
        { trustedTypes: t0 } = tV,
        t1 = t0 && tq(t0.createPolicy) && t0.createPolicy('UX4Gmap', { createHTML: t => t }),
        t2 = t1 ? t1.createHTML('') : '';
      class t3 {
            ...
            tJ(t, (e, i) => {
              ...
              (-1 === t3.allowedAttributes.indexOf(i) && (s = !1),
                -1 !== ['background', 'dynsrc', 'href', 'lowsrc', 'src'].indexOf(i) &&
                  (s = tK(e) && t3.allowedReferences.some(t => 0 === e.indexOf(t))),
                s || (t_(33, !1, void 0, { 'Invalid attribute in config': `${i}` }), delete t[i]),
      ...
      ((t3.allowedAttributes = [
        ...
        (t3.allowedReferences = ['https://', 'http://', 'mailto:', '/', '../', './', '#']),
        (t3.allowedTags = [
          'a',
          'abbr',
          'b',
        ...
        let s = /\{([\p{L}\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/gu,
          ...
          c = (t = '') => {
            ...
            return (
              'true' === t ||
              ('false' !== t &&
                ((i = Number(t)).toString() === t ? i : en(t) ? t.slice(1, -1) : t4(t, e)))
            );
          },
          p,
          u,
          ...
          r.forEach(s => {
            ...
            if (f) {
              ...
              for (p = 0; p <= a; p++) {
                let t = m.charAt(p);
                (l || ('"' !== t && "'" !== t) ? l === t && (l = '') : (l = t),
                  l || (' ' !== t && p !== a) || (o.push(m.substr(n, p - n)), (n = p + 1)));
              }
              for (p = er[f].length; p--; ) t.unshift(c(o[p + 1]));
              ((r = er[f].apply(e, t)),
                s.isBlock && 'boolean' == typeof r && (r = el(r ? u : g, e, i)));
            } else {
              ...
              if (((r = c(t.shift() || '')), t.length && 'number' == typeof r)) {
                ...
                if (a.test(e)) {
                  ...
                  null !== r &&
                    (r = d(r, t, l.decimalPoint, e.indexOf(',') > -1 ? l.thousandsSep : ''));
        ...
        (i ?? (i = l.decimalPoint),
          ...
          -1 === e
            ...
            : et(e)
              ...
              : (e = 2),
          n && (e ?? (e = 2), (t = a)),
          et(e) && e >= 0 && ((c.minimumFractionDigits = e), (c.maximumFractionDigits = e)),
          '' === s && (c.useGrouping = !1));
        let p = s || i,
      ...
      (r || (r = {})).distribute = function t(e, i, s) {
        ...
        for (
          em(e, a),
            e = e.map(t => ({ size: t.size, targets: [t.target], align: eu(t.align, 0.5) }));
          g;

        ) {
          for (c = e.length; c--; )
            ((m = e[c]),
              (f = (Math.min.apply(0, m.targets) + Math.max.apply(0, m.targets)) / 2),
      ...
      let ef = r,
        ...
        { deg2rad: ev, doc: eM, svg: ew, SVG_NS: ek, win: eS, isFirefox: eT } = A,
        {
          addEvent: eC,
          attr: eA,
          createElement: eP,
      ...
      class e_ {
            ...
            if (
              ...
              if (
                ...
                'radialGradient' === r &&
                  ...
                  !eE(a.gradientUnits) &&
                  ((n = a),
                  (a = eG(a, s.getRadialAttr(p, n), { gradientUnits: 'userSpaceOnUse' }))),
                eF(a, function (t, e) {
                  'id' !== e && g.push(e, t);
                }),
                eF(h, function (t) {
                ...
                ((t.radAttr = n),
                  ...
                  h.forEach(function (e) {
                    0 === e[1].indexOf('rgba')
                      ? ((d = (o = tA.parse(e[1])).get('rgb')), (c = o.get('a')))
                      : ((d = e[1]), (c = 1));
                    let i = s
                      .createElement('stop')
        ...
        destroy() {
          ...
          for (t.safeRemoveChild(e); o && o.div && 0 === o.div.childNodes.length; )
        ...
        dSetter(t, e, i) {
          (eN(t) &&
            ...
            (this.pathArray = t),
            (t = t.reduce(
              (t, e, i) => (e && e.join ? (i ? t + ' ' : '') + e.join(' ') : (e || '').toString()),
              '',
            ))),
        ...
        getBBox(t, e) {
          ...
          if (
            ...
            ((s = i.height),
              u &&
                (i.height = s =
                  { '11px,17': 14, '13px,20': 16 }[`${m || ''},${Math.round(s)}`] || s),
        ...
        getRotatedBox(t, e) {
          let { x: i, y: s, width: o, height: r } = t,
            { alignValue: a, translateY: n, rotationOriginX: l = 0, rotationOriginY: h = 0 } = this,
            d = ez(a),
        ...
        constructor(t, e) {
          ((this.onEvents = {}),
            ...
            (this.SVG_NS = ek),
            (this.element =
              'span' === e || 'body' === e ? eP(e) : eM.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            eB(this, 'afterInit'));
        }
        ...
        strokeWidth() {
          ...
          return (
            /px$/.test(t)
              ? (e = eY(t))
              : '' !== t &&
                (eA((i = eM.createElementNS(ek, 'rect')), { width: t, 'stroke-width': 0 }),
        ...
        updateTransform(t = 'transform') {
          ...
          (eE(i) && d.push('matrix(' + i.join(',') + ')'),
            ...
            (eE(a) || eE(n)) && d.push('scale(' + eH(a, 1) + ' ' + eH(n, 1) + ')'),
        ...
        zIndexSetter(t, e) {
          ...
          if (
            (eE(t)
              ? (r.setAttribute('data-z-index', t), (t = +t), this[e] === t && (p = !1))
              : eE(this[e]) && r.removeAttribute('data-z-index'),
            (this[e] = t),
            p)
          ) {
            for (
              (t = this.zIndex) && s && (s.handleZ = !0), u = (n = o.childNodes).length - 1;
              u >= 0 && !d;
              u--
            )
      ...
      class e6 extends eq {
        constructor(t, e, i, s, o, r, a, n, l, h) {
          ...
          (super(t, 'g'),
            ...
            (this.baseline = l),
            (this.className = h),
            this.addClass('button' === h ? 'UX4Gmap-no-tooltip' : 'UX4Gmap-label'),
        ...
        alignSetter(t) {
          ...
          ((this.textAlign = t),
            e !== this.alignFactor &&
              ((this.alignFactor = e),
              this.bBox && e0(this.xSetting) && this.attr({ x: this.xSetting })));
        }
        anchorXSetter(t, e) {
          ((this.anchorX = t),
        ...
        onAdd() {
          (this.text.add(this),
            this.attr({ text: e2(this.textStr, ''), x: this.x || 0, y: this.y || 0 }),
            this.box &&
              eK(this.anchorX) &&
        ...
        updateBoxSize() {
          ...
          let e = this.text,
            ...
            s = this.padding,
            o = (this.bBox =
              (!e0(this.widthSetting) || !e0(this.heightSetting) || this.textAlign) && eK(e.textStr)
                ? e.getBBox(void 0, 0)
                : e6.emptyBBox);
        ...
        updateTextPadding() {
          ...
          if (!t.textPath) {
            ...
            let i = this.baseline ? 0 : this.baselineOffset,
              s =
                (this.paddingLeft ?? this.padding) + eQ(e) * (this.widthSetting ?? this.bBox.width);
            ((s !== t.x || i !== t.y) &&
        ...
        if (o) {
          ...
          ((b.params = { start: a, end: c, cx: t, cy: e }),
            ...
            e5(p) &&
              ...
              r.push(u ? ['M', t + p * f, e + p * x] : ['L', t + p * f, e + p * x], b)),
            u || r.push(['Z']));
        }
        return r;
      }
      ...
      let ie = {
          ...
          callout: function (t, e, i, s, o) {
            ...
            if (t + n > i - a) {
              ...
              if (l > e + a && l < e + s - a)
                h.splice(7, 1, ['L', t, l + 6], ['L', t - 6, l], ['L', t, l - 6], ['L', t, e + r]);
              else if (n > 0) {
                let i = l < e + a,
                  o = i ? e : e + s;
        ...
        { attr: ir, extend: ia, fireEvent: il, isString: ih, objectEach: id, pick: ic } = J,
        ...
        iu = class {
          ...
          modifyDOM() {
            ...
            [].forEach.call(e.element.querySelectorAll('tspan.UX4Gmap-br'), (t, s) => {
              t.nextSibling &&
                t.previousSibling &&
                (0 === s &&
                ...
                if (n) {
                  ...
                  for (; a.length; )
                    if (
                      ...
                      this.truncate(t, void 0, a, (0 === d && c) || 0, s, h, (t, e) =>
                      ...
                      a.length &&
                        (this.truncate(t, t.textContent || '', void 0, 0, s, h, ip),
                  ...
                  (n.forEach(e => {
                    ...
                    r.forEach(e => {
                      ...
                      ((s.textContent = '​'), ir(s, { dy: l, x: i }), o.insertBefore(s, t));
                    }));
              ...
              r = t => {
                [].slice.call(t.childNodes).forEach(i => {
                  i.nodeType === io.Node.TEXT_NODE
                    ? o(i, t)
                    : (-1 !== i.className.baseVal.indexOf('UX4Gmap-br') && (e.actualWidth = 0),
                      r(i));
                });
              };
            r(e.element);
              ...
              if (
                ('b' === n || 'strong' === n
                  ? l
                    ...
                    : (a.fontWeight = 'bold')
                  : ('i' === n || 'em' === n) &&
                    (l ? (o.class = 'UX4Gmap-emphasized') : (a.fontStyle = 'italic')),
      ...
      class iH {
        constructor(t, e, i, s, o, r, a) {
          let n, l;
          let h = this.createElement('svg').attr({ version: '1.1', class: 'UX4Gmap-root' }),
            d = h.element;
          (a || h.css(this.getStyle(s || {})),
            ...
            this.createElement('desc')
              .add()
              .element.appendChild(iy.createTextNode('Created with UX4Gmap 12.1.2')),
        ...
        shadowDefinition(t) {
          let e = [
              ...
              .toLowerCase()
              .replace(/[^a-z\d\-]/g, ''),
            i = iW({ color: '#000000', offsetX: 1, offsetY: 1, opacity: 0.15, width: 5 }, t);
          return (
          ...
          return (
            c ||
              ['hover', 'select', 'disabled'].forEach((t, e) => {
                (f.push(iW(f[0], t3.filterUserAttributes(p[e + 5] || g[t] || {}))),
                  x.push(f[e + 1].style),
                  delete f[e + 1].style);
              }),
            ...
            (d.setState = (t = 0) => {
              if (
                ...
                d
                  ...
                  .addClass('UX4Gmap-button-' + ['normal', 'hover', 'pressed', 'disabled'][t]),
                !c)
              ) {
                d.attr(f[t]);
                let e = x[t];
            ...
            d.attr(f[0]),
            !c && (d.css(iD({ cursor: 'default' }, m)), h && d.text.css({ pointerEvents: 'none' })),
            d
        ...
        rect(t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a['stroke-width'] = r), iD(a, n.crisp(a))), (a.fill = 'none')),
        ...
        symbol(t, e, i, s, o, r) {
          ...
          if (g)
            ('number' == typeof e && (n = g.call(this.symbols, e || 0, i || 0, s || 0, o || 0, r)),
              ...
              iD(a, { symbolName: u || void 0, x: e, y: i, width: s, height: o }),
              r && iD(a, r));
          else if (p) {
            l = t.match(c)[1];
              ...
              ['width', 'height'].forEach(t => {
                s[`${t}Setter`] = function (t, e) {
                  ...
                  (r && 'within' === r.backgroundSize && o && a && n && l
                    ? ((d = Math.min(o / n, a / l)),
                      iA(s, { width: Math.round(n * d), height: Math.round(l * d) }))
                    : s && h && s.setAttribute(e, h),
                    !i && n && l && this.translate(((o || 0) - n * d) / 2, ((a || 0) - l * d) / 2));
                };
              }),
              iE(e) && s.attr({ x: e, y: i }),
              (s.isImg = !0),
      ...
      let i1 = (t, e) => {
        if (!t.div) {
          ...
          ((t.classSetter = (t, e, i) => {
            ...
            (t.on = function () {
              return (eq.prototype.on.apply({ element: o, onEvents: t.onEvents }, arguments), t);
            }),
            (t.div = o));
        }
        return t.div;
      ...
      class i2 extends eq {
        static compose(t) {
          iQ(iY, this.compose) &&
            (t.prototype.html = function (t, e, i) {
              return new i2(this, 'span').attr({ text: t, x: Math.round(e), y: Math.round(i) });
            });
        }
        constructor(t, e) {
          (super(t, e),
        ...
        updateTransform() {
          ...
          if ((iU(t, { marginLeft: `${d}px`, marginTop: `${c}px` }), 'SPAN' === t.tagName)) {
            let n;
            ...
            if (h !== this.oldTextWidth) {
              let e = this.textPxLength
                  ? this.textPxLength
                  : (iU(t, { width: '', whiteSpace: m || 'nowrap' }), t.offsetWidth),
                s = h || 0;
            ...
            d !== this.cTT &&
              ...
              this.getSpanCorrection(
                (!i$(i) && !this.textWidth && this.textPxLength) || t.offsetWidth,
                n,
                iq(l),
              ));
        ...
        setSpanRotation(t, e, i) {
          iU(this.element, { transform: `rotate(${t}deg)`, transformOrigin: `${e}% ${i}px` });
        }
        add(t) {
          let e;
      ...
      (n || (n = {})).registerEventOptions = function (t, e) {
        ((t.eventOptions = t.eventOptions || {}),
          i8(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] && (i4(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
      ...
      let i7 = n,
        ...
        sp = class {
          ...
          addLabel() {
              ...
              e.dateTime &&
                (u
                  ? (m = (f = s.time.resolveDTLFormat(
                      i.dateTimeLabelFormats[(!i.grid && u.higherRanks[n]) || u.unitName],
                    )).main)
                  : sl(y) && (m = e.dateTime.getXDateFormat(y, i.dateTimeLabelFormats || {}))),
              (t.isFirst = d),
              (t.isLast = c));
            let b = {
              axis: e,
            ...
            let v = t =>
                l.formatter
                  ...
                  : l.format
                    ? ((t.text = e.defaultLabelFormatter.call(t)), ed.format(l.format, t, s))
            ...
            (w
              ...
              ss(g) || t.movedLabel
                ? g &&
                  g.textStr !== M &&
                  !p &&
                  (!g.textWidth || l.style.width || g.styles.width || g.css({ width: null }),
                  g.attr({ text: M }),
          ...
          getPosition(t, e, i, s) {
            ...
            return ((n.y = se(n.y, -1e9, 1e9)), sa(this, 'afterGetPosition', { pos: n }), n);
          }
            ...
            return (
              (l =
                0 === d.side
                  ...
                  : 2 === d.side
                    ? g.y + f
                    : Math.cos(i.rotation * st) * (g.y - i.getBBox(!1, 0).height / 2)),
              ...
              (x.x = t),
              (x.y = Math.round(e)),
              sa(this, 'afterGetLabelPosition', { pos: x, tickmarkOffset: r, index: a }),
              x
            );
          }
          getLabelSize() {
          ...
          handleOverflow(t) {
            ...
            (h || 'justify' !== i.overflow
              ? h < 0 && s - d * c < a
                ...
                : h > 0 && s + d * c > n && (x = Math.round((o - s) / Math.cos(h * st)))
              : ((m = s - d * c),
                (f = s + (1 - d) * c),
                m < a ? (u = t.x + u * (1 - d) - a) : f > n && ((u = n - t.x + u * d), (g = -1)),
                (u = Math.min(p, u)) < p &&
                  'center' === e.labelAlign &&
                  (t.x += g * (p - u - d * (p - Math.min(c, u)))),
                (c > u || (e.autoRotation && (l.styles || {}).width)) && (x = u)),
              x &&
                l &&
                (this.shortenLabel
                  ? this.shortenLabel()
                  : l.css(sr({}, { width: Math.floor(x) + 'px', lineClamp: e.isRadial ? 0 : 1 }))));
          }
          moveLabel(t, e) {
            let i = this,
              s = i.label,
      ...
      class sH {
        ...
        init(t, e, i = this.coll) {
          ...
          (this.type ?? (this.type = r.type || 'linear'),
            ...
            (this.categories = (sE(r.categories) && r.categories) || (this.hasNames ? [] : void 0)),
          ...
          ((this.crosshair = !0 === n ? {} : n),
            ...
            t.inverted && !this.isZAxis && s && !sk(this.reversed) && (this.reversed = !0),
                ...
                if (i.reserveSpace()) {
                  ...
                  if (
                    ...
                    (o = i.getColumn('x')).length &&
                      ...
                      sI(a) ||
                        a instanceof Date ||
                        ((o = o.filter(sI)), (a = (t = i.getXExtremes(o)).min), (n = t.max)),
                      o.length &&
                    ...
                    (sI(t.dataMin) &&
                      ((a = t.dataMin), (e.dataMin = Math.min(sR(e.dataMin, a), a))),
                      sI(t.dataMax) &&
                        ((n = t.dataMax), (e.dataMax = Math.max(sR(e.dataMax, n), n))),
                      sk(r) && (e.threshold = r),
        ...
        getPlotLinePath(t) {
          ...
          return (
            sP(this, 'getPlotLinePath', b, function (t) {
              ((u = m = (c = sM((c = sR(c, e.translate(a, void 0, void 0, r))), -1e9, 1e9)) + d),
                (g = f = l - c - d),
                sI(c)
                  ? e.horiz
                    ? ((g = o),
                      (f = l - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0)),
                      (u = m = y(u, s, s + e.width)))
                    : ((u = s),
        ...
        getMinorTickPositions() {
          ...
          if (a && a / i < this.len / 3) {
            ...
            else for (l = o + ((e[0] - o) % i); l <= r && l !== n[0]; l += i) n.push(l);
          }
        ...
        adjustForMinRange() {
          ...
          (this.isXAxis &&
            ...
            sI(s) &&
              ...
              (s = sv(h)) - o < r &&
                ((l[0] = s - r), (l[1] = i.parse(t.min) ?? s - r), (o = sb(l)))),
            (this.minRange = r),
            (this.min = o),
            (this.max = s));
        }
        getClosest() {
          ...
          if (this.categories) e = 1;
            ...
            (this.series.forEach(function (t) {
              ...
              1 === o.length
                ? i.push(o[0])
                : t.sorted && sk(s) && t.reserveSpace() && (e = sk(e) ? Math.min(e, s) : s);
            }),
          ...
          if (
            ...
            if (
              ...
              e ||
                ...
                y ||
                !(w = this.max - this.min) ||
                (!sk(A) && M && (this.min -= w * M), sk(P) || !v || (this.max += w * v)),
            ...
            (!i.polar &&
              this.min > this.max &&
              (sk(l.min) ? (this.max = this.min) : sk(l.max) && (this.min = this.max)),
              (w = this.max - this.min));
          }
          if (
        ...
        setTickPositions() {
          ...
          if (
            ...
            (n.length > this.len && (n = [n[0], n[n.length - 1]])[0] === n[1] && (n.length = 1),
              i &&
                ((this.tickPositions = n), (l = i.apply(this, [this.min, this.max])) && (n = l)));
          }
          ((this.tickPositions = n),
            ...
            !this.isLinked &&
              ...
              (this.single &&
                n.length < 2 &&
                !this.categories &&
                !this.series.some(t => t.is('heatmap') && 'between' === t.options.pointPlacement) &&
        ...
        unsquish() {
          ...
          if (i) {
            if (
              (!t.staggerLines &&
                (sI(r) ? (p = [r]) : o < t.autoRotationLimit && (p = t.autoRotation)),
              p)
            ) {
              let t, e;
              for (let i of p)
                (i === r || (i && i >= -90 && i <= 90)) &&
                  (e = (t = l(Math.abs(a / Math.sin(sy * i)))) + Math.abs(i / 360)) < c &&
                  ((c = e), (d = i), (h = t));
            }
          } else h = l(0.75 * a);
          return (
        ...
        renderUnsquish() {
          ...
          (sD(o.rotation) || (h.rotation = o.rotation || 0),
            ...
            this.autoRotation
              ...
              : n && (p = l),
            h.rotation && ((p = g > 0.5 * t.chartHeight ? 0.33 * t.chartHeight : g), c || (u = 1)),
        ...
        getOffset() {
          ...
          if (
            ...
            v &&
              ((M -= w),
              (M += m * (i ? sR(c.y, t.tickRotCorr.y + m * c.distance) : sR(c.x, m * c.distance)))),
        ...
        getTitlePosition(t) {
          let e = this.horiz,
            ...
            u = { low: a + (e ? 0 : o), middle: a + o / 2, high: a + (e ? o : 0) }[r.align],
            g =
              (e ? s + this.height : i) +
          ...
          if (i.hasData() || n) {
            ...
            (i.minorTickInterval &&
              ...
              l.length &&
                ...
                f &&
                  (0 === i.min || i.single) &&
                  (d[-1] || (d[-1] = new sp(i, -1, null, !0)), d[-1].render(-1))),
              g &&
        ...
        drawCrosshair(t, e) {
          ...
          if (
            ...
            if (
              ...
              sk(a) &&
                ((h = { value: e && (this.isXAxis ? e.x : sR(e.stackY, e.y)), translatedValue: a }),
                o.polar &&
                  sA(h, {
                    isCrosshair: !0,
                    chartX: t && t.chartX,
              ...
              l ||
                ...
                !o.styledMode &&
                  (l
                    .attr({
                      stroke:
                        i.color || (n ? tA.parse('#ccd3ff').setOpacity(0.25).get() : '#cccccc'),
      ...
      let sY = sH,
        { addEvent: sV, getMagnitude: sU, normalizeTickInterval: sZ, timeUnits: s$ } = J;
      !(function (t) {
        function e() {
        ...
        t.compose = function (t) {
          return (
            t.keepProps.includes('logarithmic') ||
              (t.keepProps.push('logarithmic'), sq(t, 'afterSetType', e), sq(t, 'afterInit', i)),
            t
          );
        };
        class s {
          ...
          getLogTickPositions(t, e, i, s) {
            ...
            if ((s || (this.minorAutoInterval = void 0), t >= 0.5))
              ...
              ((t = sK(
                (t = sJ('auto' === d ? null : d, this.minorAutoInterval, ((h - l) * c) / (p || 1))),
              )),
      ...
      !(function (t) {
        ...
        function r(t, e, i) {
          ...
          let s = this.getPlotLinePath({ value: e, force: !0, acrossPanes: i.acrossPanes }),
            ...
            d;
          if (n && s)
            for (a && ((d = n.toString() === s.toString()), (h = 0)), l = 0; l < n.length; l += 2) {
              let t = n[l],
                e = n[l + 1],
                i = s[l],
                a = s[l + 1];
      ...
      class oo {
        ...
        render() {
          ...
          let { axis: t, options: e } = this,
            ...
            v = s8(p),
            M = !f,
            w = { class: 'UX4Gmap-plot-' + (b ? 'band ' : 'line ') + (e.className || '') },
            k = b ? 'bands' : 'lines';
          if (
            (!t.chart.styledMode &&
              (v
          ...
          n ||
            ((this.label = n =
              r.text(this.getLabelText(t), 0, 0, t.useHTML).attr({
                ...
                rotation: t.rotation,
                class: 'UX4Gmap-plot-' + (i ? 'band' : 'line') + '-label ' + (t.className || ''),
                zIndex: s,
              })),
            o.chart.styledMode ||
              n.css(oe({ fontSize: '0.8em', textOverflow: i && !a ? '' : 'ellipsis' }, t.style)),
            n.add());
      ...
      class oA {
        ...
        destroy() {
          (this.label && (this.label = this.label.destroy()),
            ...
            this.renderer && ((this.renderer = this.renderer.destroy()), om(this.container)),
          ...
          if (!this.label) {
            ...
            if (
              (r
                ...
                : ((this.label = n
                    .label('', t, e, o.shape, void 0, void 0, o.useHTML, void 0, 'tooltip')
        ...
        init(t, e) {
          ((this.chart = t),
            ...
            (this.outside = ok(e.outside, !!(t.scrollablePixelsX || t.scrollablePixelsY))));
        }
        ...
        refresh(t, e) {
          ...
          (J.clearTimeout(this.hideTimer),
            (this.allowShared = !(!oy(t) && t.series && t.series.noSharedTooltip)),
          ...
          n.points = void 0;
          let f = n.series;
          if (((this.distance = ok(f.tooltipOptions.distance, 16)), !1 === m)) this.hide();
          else {
            if (this.split && this.allowShared) this.renderSplit(m, a);
              ...
              if (
                ...
                ((!s.style.width || d) &&
                  ...
                  t.attr({ class: this.getClassName(n), text: m && m.join ? m.join('') : m }),
                  this.outside &&
                    t.attr({
                      x: ou(t.x || 0, 0, this.getPlayingField().width - (t.width || 0) - 1),
                    }),
                  d || t.attr({ stroke: s.borderColor || n.color || f.color || '#666666' }),
                  this.updatePosition({
                    plotX: u,
                    plotY: g,
                    negative: n.negative,
        ...
        renderSplit(t, e) {
          ...
          function A(t, e, s, o, r = !0) {
            ...
            return (
              s
                ? ((a = M ? 0 : C), (n = ou(t - o / 2, y.left, y.right - o - (i.outside ? w : 0))))
                : ((a = e - S), (n = ou((n = r ? t - o - p : t + p), r ? n : y.left, y.right))),
              { x: n, y: a }
            );
          }
          oM(t) && (t = [!1, t]);
              ...
              let r = e[o - 1] || { isHeader: !0, plotX: e[0].plotX, plotY: a, series: {} },
                ...
                m = (d.tt = (function (t, e, s) {
                  ...
                  if (!o) {
                    ...
                    (c || ((t.fill = u.backgroundColor), (t['stroke-width'] = u.borderWidth ?? 1)),
                      (o = v
                        .label('', 0, 0, u[r ? 'headerShape' : 'shape'], void 0, void 0, u.useHTML)
                  ...
                  return (
                    ...
                    c ||
                      o
                        .css(u.style)
                        .attr({ stroke: u.borderColor || e.color || a.color || '#333333' }),
                    o
                  );
                })(d.tt, r, s.toString())),
                f = m.getBBox(),
              ...
              let { anchorX: w, anchorY: k } = (function (t) {
                ...
                if (s) ((e = Math.max(n + o, n)), (i = l + a / 2));
                  ...
                  ((e = t.pos + ou(o, -p, t.len + p)),
                    h.shouldShowTooltip(0, s.pos - l + r, { ignoreX: !0 }) && (i = s.pos + r));
                }
                return { anchorX: (e = ou(e, y.left - p, y.right + p)), anchorY: i };
              })(r);
              if ('number' == typeof k) {
                let e = f.height + 1,
        ...
        drawTracker() {
          ...
          ((o[0] += t.plotLeft - (e.translateX || 0)),
            ...
            this.tracker
              ? this.tracker.attr(s)
              : ((this.tracker = e.renderer.rect(s).addClass('UX4Gmap-tracker').add(e)),
        ...
        headerFooterFormatter(t, e) {
          ...
          return (
            ox(this, 'headerFormatter', a, function (e) {
              if (
                (r && !n && ob(t.key) && (n = r.getXDateFormat(t.key, s.dateTimeLabelFormats)),
                r && n)
              ) {
                if (ov(n)) {
                  let t = n;
        ...
        updatePosition(t) {
          ...
          (a &&
            ...
            a.setSize(ou(l + x, 0, g.documentElement.clientWidth) - 1, n + x, !1),
            (1 !== c || 1 !== p) && (og(i, { transform: `scale(${c}, ${p})` }), (m *= c), (f *= p)),
            (m += h - u.x),
            (f += d - u.y)),
      ...
      class oZ {
          ...
          (i.singular.forEach(function (i) {
            ...
            i.plural.forEach(function (e) {
              t[e].forEach(function (e) {
                e.element &&
                  e.animate(
                    oz({ x: t.startXPos }, e.startYPos ? { x: e.startXPos, y: e.startYPos } : {}),
                  );
              });
            }));
        }
            ...
            void 0 === this.x && i
              ...
              : oX(t.x) && i.options.relativeXValue
                ...
                : 'string' == typeof this.x &&
                  (e ?? (e = i.chart.time.parse(this.x)), oX(e) && (this.x = e)),
        ...
        destroy() {
          if (!this.destroyed) {
            ...
            (t.legendItem && i.legend.destroyItem(t),
              ...
              s && s.enabled ? (this.animateBeforeDestroy(), oY(a, r.duration)) : a(),
              i.pointCount--);
          }
          this.destroyed = !0;
        }
        ...
        getClassName() {
          return (
            ...
            (void 0 !== this.colorIndex ? ' UX4Gmap-color-' + this.colorIndex : '') +
        ...
        pos(t, e = this.plotY) {
          if (!this.destroyed) {
            ...
            if (oX(i) && oX(e))
              return (
                t && ((n = r ? r.pos : o.plotLeft), (l = a ? a.pos : o.plotTop)),
                o.inverted && r && a ? [a.len - e + l, r.len - i + n] : [i + n, e + l]
              );
          }
        }
        resolveColor() {
        ...
        manageEvent(t) {
          let e = oF(this.series.options.point, this.options),
            i = e.events?.[t];
          oj(i) && (!this.hcEvents?.[t] || this.hcEvents?.[t]?.map(t => t.fn).indexOf(i) === -1)
        ...
        setState(t, e) {
          ...
          if (
            ...
            (u && this.graphic.animate(u, oH(d.options.chart.animation, n.animation, r.animation)),
              f && f.hide());
          } else
            (t &&
              n &&
        ...
        haloPath(t) {
          let e = this.pos();
          return e
            ? this.series.chart.renderer.symbols.circle(oD(e[0], 1) - t, e[1] - t, 2 * t, 2 * t)
            : [];
        }
      }
      let o$ = oZ,
      ...
      class ri {
          ...
          return (
            o6(this, 'getSelectionMarkerAttrs', i, i => {
              ...
              ((h.x = o.plotLeft),
                ...
                r &&
                  ((s = t - n), (h.width = Math.max(1, Math.abs(s))), (h.x = (s > 0 ? 0 : s) + n)),
                a &&
                  ((s = e - l),
        ...
        drag(t) {
          ...
          if (
            ...
            ((e.hasCartesianSeries || e.mapView) &&
              ...
              e.styledMode || f.attr({ fill: a || o_('#334eff').setOpacity(0.25).get() })),
              f && f.attr(h),
              m && !f && c && e.pan(t, o));
          }
        }
        ...
        onDocumentMouseMove(t) {
          ...
          !s ||
            ...
            (o.target !== e.container.ownerDocument && this.inClass(o.target, 'UX4Gmap-tracker')) ||
            this.reset();
        }
        onDocumentMouseUp(t) {
        ...
        pinch(t) {
          let e = this,
            ...
            n =
              1 === a &&
              ((e.inClass(t.target, 'UX4Gmap-tracker') && i.runTrackerClick) || e.runChartClick),
            l = i.tooltip,
        ...
        runPointActions(t, e, i) {
          let s = this.chart,
            ...
            h =
              (!t || 'touchmove' !== t.type) && (!!e || (l && l.directTouch && this.isDirectTouch)),
          ...
          (this.unDocMouseMove ||
            ((this.unDocMouseMove = oQ(s.container.ownerDocument, 'mousemove', t =>
        ...
        setDOMEvents() {
          ...
          for (; i && 'BODY' !== i.tagName; )
            (this.eventsToUnbind.push(
              ...
              (i = i.parentElement));
          (this.eventsToUnbind.push(
            oQ(t, 'touchstart', this.onContainerTouchStart.bind(this), { passive: !1 }),
            oQ(t, 'touchmove', this.onContainerTouchMove.bind(this), { passive: !1 }),
          ),
            ri.unbindDocumentTouchEnd ||
              (ri.unbindDocumentTouchEnd = oQ(e, 'touchend', this.onDocumentTouchEnd.bind(this), {
                passive: !1,
              })),
        ...
        setPointerCapture() {
          ...
          !this.hasPointerCapture && s
            ...
            : this.hasPointerCapture &&
              ...
              (i.className = i.className.replace(' UX4Gmap-no-touch-action', '')),
        ...
        rl = class {
          ...
          setColumns(t, e, i) {
            ...
            (ra(t, (t, e) => {
              ...
              i?.silent || (ro(this, 'afterSetColumns'), (this.versionTag = rn())));
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            (ra(t, (t, a) => {
              ...
              s?.silent || (ro(this, 'afterSetRows'), (this.versionTag = rn())));
          }
        },
      ...
      !(function (t) {
        function e(t, e, i) {
          ...
          if (f && !1 !== f.enabled && n) {
            ...
            (0 === h.indexOf('url') && ((f = rd(f, { width: l, height: l })), (t = 0)),
              (s.symbol = m =
                c
                  .symbol(h, n / 2 - t, u - t, 2 * t, 2 * t, rh({ context: 'legend' }, f))
      ...
      class r_ {
        ...
        init(t, e) {
          let i;
          (rR(this, 'init', { options: e }), this.dataTable ?? (this.dataTable = new rl()));
          let s = t.series;
          ...
          ((this.linkedSeries = []),
            this.bindAxes(),
            rz(this, { name: o.name, state: '', visible: r, selected: !0 === o.selected }),
            rM(this, o));
          let a = o.events;
          (((a && a.click) ||
          ...
          (rR(this, 'bindAxes', null, function () {
            (e.axisTypes || []).forEach(function (o) {
              ((s[o] || []).forEach(function (s) {
                ((t = s.options),
                  (rU(i[o], 0) === s.index || (void 0 !== i[o] && i[o] === t.id)) &&
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e = rU(this.pointInterval, i.pointInterval, 1)),
            o && rF(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a);
        ...
        setDataSortingOptions() {
          let t = this.options;
          (rz(this, { requireSorting: !1, sorted: !1, enabledDataSorting: !0, allowDG: !1 }),
        ...
        setOptions(t) {
          ...
          return (
            (u.negativeColor || u.negativeFillColor) &&
              ...
              a || ((e.color = u.negativeColor), (e.fillColor = u.negativeFillColor)),
              g.push(e)),
            g.length &&
        ...
        getCyclic(t, e, i) {
          ...
          (!e &&
            (rO((o = rU('color' === t ? this.options.colorIndex : void 0, this[a])))
              ? (s = o)
        ...
        updateData(t, e) {
          ...
          if (
            ...
            t.forEach(function (t, e) {
              let h;
              let d =
                  (rO(t) && this.pointClass.prototype.optionsToObject.call({ series: this }, t)) ||
                  {},
                p = d.x;
              d.id || rF(p)
                ? (-1 === (h = this.findPointIndex(d, c)) || void 0 === h
                    ? r.push(t)
                    : o[h] && t !== i.data[h]
                      ? (o[h].update(t, !1, null, !1), (o[h].touched = !0), a && (c = h + 1))
                      : o[h] && (o[h].touched = !0),
            ...
            for (h = o.length; h--; ) (d = o[h]) && !d.touched && d.remove && d.remove(!1, e);
          else
            !n || (s && s.enabled)
              ? (p = !1)
              : (t.forEach(function (t, e) {
        ...
        setData(t, e = !0, i, s) {
          ...
          if (
            ...
            if (!e) {
              ...
              for (f = 0; f < M; f++) {
                let i = this.pointClass.prototype.applyOptions.apply({ series: this }, [t[f]]);
        ...
        sortData(t) {
          let e = this,
            ...
            s = function (t, e) {
              return (rO(e) && t.pointClass.prototype.optionsToObject.call({ series: t }, e)) || {};
            };
          return (
        ...
        generatePoints() {
          ...
          for (l && n && (this.options.keys = !1), x = 0; x < r; x++)
            ((m = a + x),
              n
                ? (((f = new o(this, i.getRow(x, u) || [])).dataGroup = this.groupMap[d + x]),
                  f.dataGroup?.options &&
        ...
        getExtremes(t, e) {
          ...
          for (i && ((x = (g = i.getExtremes()).min), (y = g.max)), f = 0; f < a; f++)
            if (((m = h[f]), u || ((h[f + c] || m) >= x && (h[f - c] || m) <= y)))
              for (let t of l) {
                let e = t[f];
                rF(e) && (e > 0 || !p) && d.push(e);
              }
        ...
        translate() {
          ...
          for (c = 0; c < a; c++) {
            ...
            let a = r[c],
              ...
              w =
                e &&
                o.stacking?.stacks[(this.negStacks && v < (d ? 0 : h) ? '-' : '') + this.stackKey];
            ((p = i.translate(x, !1, !1, !1, !0, n)),
              ...
              e &&
                ...
                y &&
                  ...
                  (a.percentage = rO(a.y) && y.total ? (a.y / y.total) * 100 : void 0),
                  (a.stackY = v),
            ...
            ((s?.element.childNodes.length || e.series.length > 1) &&
              (r.step = function (t, e) {
                (i && i.apply(e, arguments),
                  'width' === e.prop && l?.element && l.attr(o ? 'height' : 'width', t + 99));
              }),
          ...
          if (!1 !== p.enabled || this._hasPointMarkers)
            for (e = 0; e < t.length; e++)
              if (
                ...
                (r = i.marker || {}),
                (a = !!i.marker),
                ((m && void 0 === r.enabled) || r.enabled) && !i.isNull && !1 !== i.visible)
              ) {
                ...
                if (
                  (!s &&
                    ...
                    ((i.graphic = s =
                      l.renderer.symbol(t, n.x, n.y, n.width, n.height, a ? r : p).add(u)),
                    this.enabledDataSorting &&
                      l.hasRendered &&
        ...
        markerAttribs(t, e) {
          ...
          return (
            rF(h) &&
              d &&
              (i.crisp && (d[0] = rL(d[0], t.hasImage ? 0 : 'rect' === r ? s?.lineWidth || 0 : 1)),
              (a.x = d[0] - h),
              (a.y = d[1] - h)),
          ...
          return (
            ...
            r.addClass(
              'UX4Gmap-' +
                ...
                this.type +
                '-series ' +
                (rO(this.colorIndex) ? 'UX4Gmap-color-' + this.colorIndex + ' ' : '') +
          ...
          if ((this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree))
            return (function t(e, i, s, o) {
              ...
              return (
                ...
                i[y] && p(Math.sqrt(f * f), g[l], m) && (g = c(g, t(e, i[y], s + 1, o), l)[0]),
                g
              );
            })(t, this.kdTree, h, h);
        }
        ...
        addPoint(t, e, i, s, o) {
          ...
          (d.setRow(m, a, !0, { addColumns: !1 }),
            ...
            i &&
              (h[0] && h[0].remove
                ? h[0].remove(!1)
                : ([h, u, ...Object.values(d.getColumns())].filter(rO).forEach(t => {
                    t.shift();
                  }),
                  (d.rowCount -= 1),
        ...
        update(t, e) {
          ...
          let i = this,
            ...
            g = !(
              ...
              t.joinBy ||
              t.mapData ||
              ['dataGrouping', 'pointStart', 'pointInterval', 'pointIntervalUnit', 'keys'].some(t =>
                i.hasOptionChanged(t),
              )
            );
          ((u = u || r),
            g
        ...
        setState(t, e) {
          ...
          if (
            ...
            if (
              (t &&
                ((l = a[t].lineWidth || l + (a[t].lineWidthPlus || 0)), (h = rU(a[t].opacity, h))),
              o && !o.dashstyle && rF(l))
            )
      ...
      class al {
        ...
        colorizeItem(t, e) {
          ...
          if (
            ((t instanceof rq || t instanceof o$) && (t.color = t.options?.legendSymbolColor || i),
            ...
            (r?.css(ai(e ? this.itemStyle : i)),
              ...
              s?.attr(p({ fill: l || t.color, 'fill-opacity': l ? 1 : (h ?? 0.75) })));
          }
          ((t.color = i), at(this, 'afterColorizeItem', { item: t, visible: e }));
        }
        positionItems() {
        ...
        renderItem(t) {
          ...
          (!y &&
            ...
            !this.baseline &&
              ...
              o.squareSymbol &&
                ((this.symbolWidth = as(o.symbolWidth, Math.max(this.symbolHeight, 16))),
          ...
          ((t.itemWidth = t.checkboxOffset = o.itemWidth || e.labelWidth || v.width + b),
            ...
            (this.itemHeight = t.itemHeight =
              Math.round(e.labelHeight || (v.height > 1.5 * M ? v.height : M))));
        }
        layoutItem(t) {
          let e = this.options,
            i = this.padding,
          ...
          (s &&
            ...
            (d.x = this.itemX),
            (d.y = this.itemY),
            s ? (this.itemX += h) : ((this.itemY += a + o + r), (this.lastLineHeight = o)),
            (this.offsetWidth =
              this.widthOption ||
              Math.max((s ? this.itemX - i - (t.checkbox ? 0 : n) : h) + i, this.offsetWidth)));
        }
        getAllItems() {
          let t = [];
          return (
        ...
        proximatePositions() {
          ...
          for (let o of (this.allItems.forEach(function (t) {
            ...
            t.yAxis &&
              ...
              t.points &&
                (o = r7(a ? t.points : t.points.slice(0).reverse(), function (t) {
                  return ae(t.plotY);
                })),
              (r =
                this.itemMarginTop + t.legendItem.label.getBBox().height + this.itemMarginBottom),
              (l = t.yAxis.top - e.plotTop),
              (n = t.visible ? (o ? o.plotY : t.yAxis.height) + (l - 0.3 * r) : l + t.yAxis.height),
              i.push({ target: n, size: r, item: t }));
          }, this),
          r2(i, e.plotHeight)))
            ((t = o.item.legendItem || {}), ae(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos));
        }
        render() {
          let t = this.chart,
            e = t.renderer,
          ...
          ((this.itemX = s),
            ...
            d ||
              (this.box = d =
                e.rect().addClass('UX4Gmap-legend-box').attr({ r: i.borderRadius }).add(l)),
            t.styledMode ||
              d
                .attr({
        ...
        handleOverflow(t) {
          ...
          return (
            ...
            t && b > 0 && t > b && !1 !== h.enabled
              ? ((this.clipHeight = f = Math.max(b - 20 - this.titleHeight - n, 0)),
                ...
                v ||
                  ...
                  (this.pager = s.text('', 15, 10).addClass('UX4Gmap-legend-navigation')),
          ...
          (h > o && (h = o),
            h > 0 &&
              ...
              [this.up, this.upTracker].forEach(function (t) {
                t.attr({
                  class: 1 === h ? 'UX4Gmap-legend-nav-inactive' : 'UX4Gmap-legend-nav-active',
                });
              }),
              n.attr({ text: h + '/' + o }),
              [this.down, this.downTracker].forEach(function (t) {
                t.attr({
                  ...
                  class: h === o ? 'UX4Gmap-legend-nav-inactive' : 'UX4Gmap-legend-nav-active',
                });
              }, this),
              i.styledMode ||
                (this.up.attr({ fill: 1 === h ? a.inactiveColor : a.activeColor }),
                this.upTracker.css({ cursor: 1 === h ? 'default' : 'pointer' }),
                this.down.attr({ fill: h === o ? a.inactiveColor : a.activeColor }),
        ...
        createCheckboxForItem(t) {
          ((t.checkbox = r5(
            ...
            r6(t.checkbox, 'click', function (e) {
              let i = e.target;
              at(t.series || t, 'checkboxClick', { checked: i.checked, item: t }, function () {
                t.select();
              });
            }));
        }
      ...
      class a_ {
        ...
        init(t, e) {
          aD(this, 'init', { args: arguments }, function () {
            ...
            ((this.userOptions = aE({}, t)),
              (this.renderTo = aj(o) ? ax.getElementById(o) : o) || aO(13, !0, this),
              (this.margin = []),
              (this.spacing = []),
        ...
        isInsidePlot(t, e, i = {}) {
          ...
          if (!i.ignoreX) {
            ...
            (e >= Math.max(l + r, t.pos) && e <= Math.min(l + r + c.width, t.pos + t.len)) ||
              (g.isInsidePlot = !1);
          }
          if (!i.ignoreY && g.isInsidePlot) {
            ...
            (e >= Math.max(h + a, t.pos) && e <= Math.min(h + a + c.height, t.pos + t.len)) ||
              (g.isInsidePlot = !1);
          }
          ...
          (o && e && (this[t] = o = o.destroy()),
            s &&
              ...
              (((o = this.renderer
                ...
                .attr({ align: s.align, class: 'UX4Gmap-' + t, zIndex: s.zIndex || 4 })
        ...
        layOutTitles(t = !0) {
          ...
          (['title', 'subtitle', 'caption'].forEach(t => {
            ...
            if (i && r) {
              ...
              let y = Math.round(i.css({ width: `${x}px` }).getBBox(r.useHTML).height);
              if (
                ((f.height = y),
                i.align(f, !1, a).attr({
                  align: f.align,
        ...
        getChartSize() {
          ...
          ((this.chartWidth = Math.max(0, e || s.width || 600)),
            (this.chartHeight = Math.max(0, aY(i, this.chartWidth) || (o ? 400 : s.height))),
            (this.containerBox = s));
        }
        temporaryDisplay(t) {
          let e = this.renderTo,
          ...
          if (t)
            for (; e && e.style; )
              (e.hcOrigStyle && (aT(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached && (ax.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode));
          else
            for (
              ;
        ...
        getContainer() {
          ...
          ((this.container = h),
            ...
            l === this.chartWidth ||
              ((l = this.chartWidth),
              this.styledMode || aT(h, { width: aF(i.style?.width, l + 'px') })),
        ...
        getMargins(t) {
          ...
          (this.resetMargins(),
            s[0] && !aC(i[0]) && (this.plotTop = Math.max(this.plotTop, s[0] + e[0])),
            s[2] && !aC(i[2]) && (this.marginBottom = Math.max(this.marginBottom, s[2] + e[2])),
        ...
        setSize(t, e, i) {
          ...
          ((s.isDirtyBox || a !== s.oldChartWidth || n !== s.oldChartHeight) &&
            (s.styledMode ||
              (r ? ad : aT)(s.container, { width: `${a + l}px`, height: `${n + h}px` }, r),
            s.setChartSize(!0),
            o.setSize(a, n, r),
        ...
        setChartSize(t) {
          let e, i, s, o;
          let { chartHeight: r, chartWidth: a, inverted: n, spacing: l, renderer: h } = this,
            d = this.clipOffset,
            c = Math[n ? 'floor' : 'round'];
          ((this.plotLeft = e = Math.round(this.plotLeft)),
            (this.plotTop = i = Math.round(this.plotTop)),
            (this.plotWidth = s = Math.max(0, Math.round(a - e - this.marginRight))),
            (this.plotHeight = o = Math.max(0, Math.round(r - i - this.marginBottom))),
            (this.plotSizeX = n ? o : s),
            (this.plotSizeY = n ? s : o),
            (this.spacingBox = h.spacingBox =
              { x: l[3], y: l[0], width: a - l[3] - l[1], height: r - l[0] - l[2] }),
        ...
        drawChartBox() {
          let t = this.options.chart,
            ...
            w = 'animate';
          (f ||
            ((this.chartBackground = f = e.rect().addClass('UX4Gmap-background').add()),
            (w = 'attr')),
            o
              ? (b = v = f.strokeWidth())
              : ((v = (b = t.borderWidth || 0) + (t.shadow ? 8 : 0)),
                (M = { fill: a || 'none' }),
                (b || f['stroke-width']) && ((M.stroke = t.borderColor), (M['stroke-width'] = b)),
            ...
            x ||
              ((w = 'attr'),
              (this.plotBackground = x = e.rect().addClass('UX4Gmap-plot-background').add())),
            x[w](u),
            !o &&
            ...
            g ? g.animate({ width: m.width, height: m.height }) : (this.clipRect = e.clipRect(m)),
            (w = 'animate'),
            y ||
              ((w = 'attr'),
              (this.plotBorder = y =
                e.rect().addClass('UX4Gmap-plot-border').attr({ zIndex: 1 }).add())),
            o ||
              y.attr({
            ...
            y[w](y.crisp({ x: h, y: d, width: c, height: p }, -y.strokeWidth())),
            (this.isDirtyBox = !1),
        ...
        propFromSeries() {
          ...
          ['inverted', 'angular', 'polar'].forEach(function (a) {
            for (e = aM[o.type], i = o[a] || (e && e.prototype[a]), t = r && r.length; !i && t--; )
            ...
            i.forEach(function (t) {
              ...
              if (aj(i)) {
                ...
                (s = ':previous' === i ? e.series[t.index - 1] : e.get(i)) &&
                  ...
                  (t.visible = aF(t.options.visible, s.options.visible, t.visible)));
              }
            }),
        ...
        render() {
          ...
          for (this.plotHeight = Math.max(this.plotHeight - r, 0); (a || n || s > 1) && l < s; ) {
            let e = this.plotWidth,
              i = this.plotHeight;
            for (let e of t)
              0 === l ? e.setScale() : ((e.horiz && a) || (!e.horiz && n)) && e.setTickInterval(!0);
        ...
        destroy() {
          ...
          for (
            ...
            i[t] = i[t].destroy();
          for (
            this.scroller && this.scroller.destroy && this.scroller.destroy(), t = s.length;
            t--;
        ...
        showLoading(t) {
          ...
          (r ||
            ...
            a ||
              ((e.loadingSpan = a = aS('span', { className: 'UX4Gmap-loading-inner' }, null, r)),
              aw(e, 'redraw', o)),
            ...
            e.styledMode ||
              ...
              e.loadingShown ||
                ...
                ad(r, { opacity: s.style.opacity || 0.5 }, { duration: s.showDuration || 0 }))),
            (e.loadingShown = !0),
            o());
        }
        hideLoading() {
          ...
          (c &&
            ...
            aG(c, function (t, e) {
              (-1 !== n.propsRequireUpdateSeries.indexOf('chart.' + e) && (r = !0),
                ...
                -1 === n.propsRequireReflow.indexOf(e) || ((n.isDirtyBox = !0), h || (a = !0)));
            }),
        ...
        transform(t) {
          ...
          for (let t of (this.hoverPoints?.forEach(t => t.setState()), e)) {
            let { horiz: e, len: u, minPointOffset: g = 0, options: m, reversed: f } = t,
              x = e ? 'width' : 'height',
              y = e ? 'x' : 'y',
              b = aF(a[x], t.len),
              v = aF(s[x], t.len),
            ...
            if ((T > C && ([T, C] = [C, T]), 1 === M && !o && 'yAxis' === t.coll && !A)) {
              for (let e of t.series) {
                ...
                (A ?? (A = { dataMin: Number.MAX_VALUE, dataMax: -Number.MAX_VALUE }),
                  aR(t.dataMin) &&
                    aR(t.dataMax) &&
            ...
            let { dataMin: P, dataMax: L, min: O, max: E } = aE(t.getExtremes(), A || {}),
              I = h.parse(m.min),
              D = h.parse(m.max),
              B = P ?? I,
              z = L ?? D,
            ...
            (!t.isOrdinal || t.options.overscroll || 1 !== M || o) &&
              (T < G && ((T = G), M >= 1 && (C = T + N)),
              C > F && ((C = F), M >= 1 && (T = C - N)),
              (o || (t.series.length && (T !== O || C !== E) && T >= G && C <= F)) &&
                (r
      ...
      class a4 {
        ...
        static afterSetSize(t, e) {
          let i, s, o;
          let { minWidth: r, minHeight: a } = t.options.chart.scrollablePlotArea || {},
        ...
        constructor(t) {
          ...
          let n = (this.parentDiv = a0(
            ...
            l = (this.scrollingContainer = a0('div', { className: 'UX4Gmap-scrolling' }, a, n)),
        ...
        applyFixed() {
          ...
          (e.setSize(r, a),
            ...
            t.renderer.boxWrapper.attr({ width: f, height: x, viewBox: [0, 0, f, x].join(' ') }),
      ...
      let { format: a7 } = ed,
        ...
        na = class {
          ...
          setOffset(t, e, i, s, o, r) {
            let { alignOptions: a, axis: n, label: l, options: h, textAlign: d } = this,
              c = n.chart,
              p = this.getStackBox({
                xOffset: t,
                width: e,
            ...
            if (l && p) {
              ...
              ((p.x -= o),
                (p.y -= r),
                l.align(a, !1, p),
                (s = c.isInsidePlot(l.alignAttr.x + a.x + o, l.alignAttr.y + a.y + r)) || (i = !1),
                i && nt.prototype.justifyDataLabel.call(n, l, a, l.alignAttr, t, p),
                l.attr({
                  x: l.alignAttr.x,
                  y: l.alignAttr.y,
                  rotation: h.rotation,
          ...
          getStackBox(t) {
            let e = this.axis,
              ...
              p = Math.abs(
                h -
                  e.toPixels(
                    n || (no(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min)) || 0,
                  ),
              ),
              u = i.inverted,
              g = this.isNegative;
        ...
        for (M.stacksTouched += 1, l = 0; l < u; l++) {
          ...
          ('percent' === h
            ? ((r = s ? y : b),
              (S =
                v && w[r]?.[e]
                  ? ((r = w[r][e]).total = Math.max(r.total || 0, S) + Math.abs(g))
                  : nd(S + Math.abs(g))))
            : 'group' === h
              ? ng(u) && S++
              : (S = nd(S + g)),
            ...
            (o.total = S),
            null !== u &&
              (o.points[n].push(o.cumulative), (p[l] = o.cumulative), (o.hasValidPoints = !0)));
        }
          ...
          [this, ...this.zones].forEach((s, o) => {
            ...
            (a
              ...
              a &&
                ...
                a[n](r).shadow(
                  t.shadow && nP({ filterUnits: 'userSpaceOnUse' }, nL(t.shadow) ? t.shadow : {}),
                )),
      ...
      ((nO.defaultOptions = nP(rq.defaultOptions, { legendSymbol: 'lineMarker' })),
        ...
        getGraphPath(t) {
            ...
            m = function (i, s, o) {
              ...
              (f || m
                ...
                void 0 !== x &&
                  ...
                  l.push({ plotX: e, plotY: null === y ? u : n.getThreshold(y), doCurve: !1 })));
            };
          ...
          for (let o = 0, r = t.length; o < r; ++o)
            (a || (t[o].leftCliff = t[o].rightCliff = t[o].leftNull = t[o].rightNull = void 0),
              ...
              (i && !g) ||
                (g || m(o, o - 1, 'left'),
                (i && !a && g) || (h.push(t[o]), l.push({ x: o, plotX: e, plotY: s })),
                g || m(o, o + 1, 'right')));
      ...
      ((nN.defaultOptions = nD(nE.defaultOptions, { threshold: 0, legendSymbol: 'areaMarker' })),
      ...
      class n9 extends rq {
        animate(t) {
          ...
          t && l
            ? ((d.scaleY = 0.001),
              ...
              h
                ? ((i += a ? -Math.floor(l[0]) : Math.ceil(l[2])), (d.translateX = i - o.len))
                : ((i += a ? Math.ceil(l[0]) : -Math.floor(l[2])), (d.translateY = i)),
              s.clipBox && s.setClip(),
              s.group.attr(d))
            ...
            t.points.forEach(function (s) {
              ...
              (l &&
                ...
                nJ(s.options.pointWidth) &&
                  (k -= Math.round(((w = S = Math.ceil(s.options.pointWidth)) - d) / 2)),
                i.centerInCategory && (k = t.adjustForMissingColumns(k, w, s, h)),
                (s.barX = k),
                (s.pointWidth = w),
                (s.tooltipPos = e.inverted
                  ...
                  : [
                      ...
                      nq(y + a.pos - e.plotTop, a.pos - e.plotTop, a.len + a.pos - e.plotTop),
                      M,
                    ]),
                (s.shapeType = t.pointClass.prototype.shapeType || 'roundedRect'),
                (s.shapeArgs = t.crispCol(k, s.isNull ? g : v, S, s.isNull ? 0 : M)));
            }),
            n0(this, 'afterColumnTranslate'));
        }
        drawGraph() {
          this.group[this.dense ? 'addClass' : 'removeClass']('UX4Gmap-dense-data');
        }
        pointAttribs(t, e) {
          let i = this.options,
          ...
          (t &&
            this.zones.length &&
            ((n = t.getZone()),
            (h = t.options.color || (n && (n.color || t.nonZonedColor)) || this.color),
            n && ((d = n.borderColor || d), (c = n.dashStyle || c), (p = n.borderWidth || p))),
            e &&
              t &&
              ((l = (a = n3(i.states[e], (t.options.states && t.options.states[e]) || {}))
                .brightness),
              (h = a.color || (void 0 !== l && n$(h).brighten(a.brightness).get()) || h),
              (d = a[o] || d),
              (p = a[r] || p),
              (c = a.dashStyle || c),
              (u = n6(a.opacity, u))));
        ...
        drawTracker(t = this.points) {
          ...
          (t.forEach(function (t) {
            ((e = n1(t.dataLabels) ? t.dataLabels : t.dataLabel ? [t.dataLabel] : []),
      ...
      !(function (t) {
        ...
        function i(t, e, i, s, o) {
          let { chart: r, enabledDataSorting: a } = this,
            ...
            c =
              lt(l) &&
              lt(h) &&
              r.isInsidePlot(l, Math.round(h), { inverted: n, paneCoordinates: !0, series: this }),
          ...
          if (u && g) {
            ...
            if (
              ((s = le({ x: g[0], y: Math.round(g[1]), width: 0, height: 0 }, s || {})),
              'plotEdges' === i.alignTo &&
                this.isCartesian &&
          ...
          (o && a && (e.placed = !1),
            u || (a && !p) ? (e.show(), (e.placed = !0)) : (e.hide(), (e.placed = !1)));
        }
        function s() {
              ...
              t.forEach(t => {
                ...
                ld(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                  let h =
                    ...
                    { backgroundColor: c, borderColor: p, distance: u, style: g = {} } = n,
                    m,
                    f,
                    x,
                    y = {},
                  ...
                  (h &&
                    ...
                    (x = n.rotation),
                    !s.styledMode &&
                      ((g.color = ll(n.color, g.color, lr(i.color) ? i.color : void 0, '#000000')),
                      'contrast' === g.color
                        ? ('none' !== c && (M = c),
                          ...
                          (g.color =
                            M || (!lt(u) && n.inside) || 0 > lh(u || 0) || o.stacking
                              ? t.contrastColor
                              : d))
                        : delete t.contrastColor,
                      o.cursor && (g.cursor = o.cursor)),
                    (y = { r: n.borderRadius || 0, rotation: x, padding: n.padding, zIndex: 1 }),
                    s.styledMode ||
                    ...
                    !b ||
                      (h &&
                        lt(f) &&
                        !!b.div == !!n.useHTML &&
                        ((b.rotation && n.rotation) || b.rotation === n.rotation)) ||
                      ((b = void 0), (v = !0)),
                    h &&
                      lt(f) &&
                      (b
                      ...
                      b &&
                        ...
                        li(b, 'beforeAddingDataLabel', { labelOptions: n, point: t }),
                        b.added || b.add(e),
                ...
                let l = a.length;
                for (; l--; )
                  a[l] && a[l].isActive ? (a[l].isActive = !1) : (a[l]?.destroy(), a.splice(l, 1));
        ...
        function a(t, e, i, s, o, r) {
          ...
          return (
            (f = (i.x || 0) + h + c) < 0 &&
              ('right' === n && g >= 0 ? ((e.align = 'left'), (e.inside = !0)) : (g -= f),
              (x = !0)),
            (f = (i.x || 0) + s.width - h + c) > a.plotWidth &&
              ...
              (x = !0)),
            (f = i.y + h + u) < 0 &&
              ('bottom' === l && m >= 0 ? ((e.verticalAlign = 'top'), (e.inside = !0)) : (m -= f),
              (x = !0)),
      ...
      !(function (t) {
        function e(t, e, i, s, o) {
          ...
          ((i.align = lm(i.align, !r || c ? 'center' : d ? 'right' : 'left')),
            (i.verticalAlign = lm(i.verticalAlign, r || c ? 'middle' : d ? 'top' : 'bottom')),
      ...
      !(function (t) {
        ((t.getCenter = function () {
          ...
          for (!e.angular || this instanceof rq || (u[3] = 0), c = 0; c < 4; ++c)
            ((p = u[c]),
              (l = c < 2 || (2 === c && /%$/.test(p))),
      ...
      let lI = f,
        { setAnimation: lD } = tH,
        { addEvent: lB, defined: lz, extend: lN, isNumber: lR, pick: lW, relativeLength: lj } = J;
      class lX extends o$ {
        getConnectorPath(t) {
        ...
        animate(t) {
          ...
          t ||
            i.forEach(function (t) {
              ...
              i &&
                o &&
                (i.attr({ r: lZ(t.startR, e.center && e.center[3] / 2), start: s, end: s }),
      ...
      let { composed: l_, noop: lq } = A,
        { distribute: lK } = ef,
        { series: lJ } = rx,
        { arrayMax: lQ, clamp: l0, defined: l1, pick: l2, pushUnique: l3, relativeLength: l6 } = J;
      !(function (t) {
        let e = {
                    ...
                    if (x) {
                      if (
                        (u &&
                          ...
                          (void 0 === f.pos
                            ? (S = 'hidden')
                            : ((m = f.size), (k = p.radialDistributionY(i, h)))),
                        d.justify)
                      )
                        w = p.justify(i, h, l, n);
                      else
                      ...
                      if (
                        ...
                        (w - (g = h.getBBox().width) < b && 1 === a
                          ? ((t = Math.round(g - w + b)), (c[3] = Math.max(t, c[3])))
                          : w + g > s - b &&
                            0 === a &&
                            ((t = Math.round(w + g - s + b)), (c[1] = Math.max(t, c[1]))),
                          k - m / 2 < 0
                            ? (c[0] = Math.max(Math.round(-k + m / 2), c[0]))
                            : k + m / 2 > o && (c[2] = Math.max(Math.round(k + m / 2 - o), c[2])),
                          (x.sideOverflow = t));
                      }
                    }
                  });
                    ...
                    ((u = s.connector),
                      a && a.distance > 0
                        ? ((n = !u),
                          ...
                          i.styledMode ||
                            u.attr({ 'stroke-width': r, stroke: o || e.color || '#666666' }),
                          u[n ? 'attr' : 'animate']({ d: e.getConnectorPath(s) }),
          ...
          return (
            !a &&
              ...
              null !== s[1]
                ...
                : ((r = l0(r, o, e[2] - t[0] - t[2])), (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
                    i.thickness
          ...
          t &&
            ...
            t.oldOpacity !== s &&
              (t.hasClass('UX4Gmap-data-label')
                ? (t[s ? 'removeClass' : 'addClass']('UX4Gmap-data-label-hidden'),
                  (i = function () {
                    e.styledMode || t.css({ pointerEvents: s ? 'auto' : 'none' });
                  }),
                  (o = !0),
              ...
              for (let s of i)
                s.visible &&
                  (s.dataLabels || []).forEach(i => {
                    let o = i.options || {};
                    ((i.labelrank = he(o.labelrank, s.labelrank, s.shapeArgs?.height)),
                      (o.allowOverlap ?? Number(o.distance) > 0)
                        ? ((i.oldOpacity = i.opacity), (i.newOpacity = 1), hs(i, t))
                        : e.push(i));
                  });
            };
      ...
      let hr = {
        ...
        { noop: hn } = A,
        { addEvent: hl, extend: hh, isObject: hd, merge: hc, relativeLength: hp } = J,
      ...
      let { diffObjects: hM, extend: hw, find: hk, merge: hS, pick: hT, uniqueKey: hC } = J;
      !(function (t) {
        function e(t, e) {
          let i = t.condition;
          (
        ...
        function i(t, e) {
          ...
          o === n ||
            ...
            o
              ? (((r = hM(a, this.options, !0, this.collectionsWithUpdate)).isResponsiveOptions =
                  !0),
        ...
        t.compose = function (t) {
          let s = t.prototype;
          return (s.matchResponsiveRule || hw(s, { matchResponsiveRule: e, setResponsive: i }), t);
        };
      })(b || (b = {}));
      let hA = b;
      ((A.AST = t3),
      ...
      !(function (t) {
        ...
        function i() {
          ...
          ((this.colorAxis = []),
            t.colorAxis && ((t.colorAxis = hD(t.colorAxis)), t.colorAxis.map(t => new e(this, t))));
        }
        function s(t) {
          ...
          f.collectionsWithUpdate.includes('colorAxis') ||
            ...
            (function (t) {
              ...
              t.prototype.createAxis = function (t, s) {
                ...
                let o = new e(this, hE(s.axis, { index: this[t].length, isX: !1 }));
                return (
            ...
            ((r = hN((r = o[t]))),
              ...
              (e.styledMode || !r.color) &&
                ('category' === s.dataClassColor
                  ? (e.styledMode || ((n = (h = e.options.colors || []).length), (r.color = h[l])),
                    (r.colorIndex = l),
                    ++l === n && (l = 0))
                  : (r.color = hz(s.minColor).tweenTo(hz(s.maxColor), i < 2 ? 0.5 : t / (i - 1)))));
        }),
      ...
      class h$ extends sY {
        ...
        init(t, e) {
          ...
          ((this.side = e.side || s ? 2 : 1),
            ...
            (this.userOptions = e),
            hH(t.userOptions.colorAxis) && (t.userOptions.colorAxis[this.index] = e),
        ...
        getOffset() {
          ...
          if (t) {
            ...
            (i.allItems.forEach(function (t) {
              ...
              this.chart.series.some(t => t.isDrilling) || (this.isDirty = !0),
              this.added ||
          ...
          (this.setLegendColor(),
            i.symbol ||
              (i.symbol = this.chart.renderer
                ...
                .add(i.group)),
            i.symbol.attr({ x: 0, y: (t.baseline || 0) - 11, width: l, height: h }),
            (i.labelWidth = l + s + (n ? a : hU(r.x, r.distance) + (this.maxLabelLength || 0))),
        ...
        getSeriesExtremes() {
          ...
          for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; r--; ) {
            for (let a of ((i = (o = t[r]).colorKey =
              hU(o.options.colorKey, o.colorKey, o.pointValKey, o.zoneAxis, 'y')),
            (s = o[i + 'Min'] && o[i + 'Max']),
            [i, 'value', 'y']))
        ...
        update(t, e) {
          ...
          (this.series.forEach(t => {
            ...
            ((t.dataClasses && i.allItems) || this.dataClasses) && this.destroyItems(),
            super.update(t, e),
            this.legendItem &&
        ...
        getDataClassLegendSymbols() {
          ...
          let e = this,
            ...
            n = t =>
              e.series.reduce(
                (e, i) => (e.push(...i.points.filter(e => e.dataClass === t)), e),
                [],
              );
          return (
            s.length ||
      ...
      !(function (t) {
        ...
        function r(t, e, i) {
          ...
          if (((e = t.call(this, e, i)), s && s.mapView)) {
            let t = s.mapView.pixelsToLonLat({ x: e.chartX - s.plotLeft, y: e.chartY - s.plotTop });
            t && hK(e, t);
          }
          return e;
        }
        function a(t) {
          ...
          (e && hJ(e.enableTouchZoom, e.enabled) && (this.chart.zooming.pinchType = 'xy'),
      ...
      let h3 = {
        ...
        { setOptions: h6 } = tw,
        { composed: h5 } = A,
        { addEvent: h9, extend: h8, merge: h4, objectEach: h7, pick: dt, pushUnique: de } = J;
      function di(t) {
      ...
      class ds {
        ...
        update(t) {
          ...
          for (t && (r = i.options.mapNavigation = h4(i.options.mapNavigation, t)); s.length; )
            s.pop()?.destroy();
          if (!i.renderer.forExport && dt(r.enableButtons, r.enabled)) {
            (e.navButtonsGroup || (e.navButtonsGroup = i.renderer.g().attr({ zIndex: 7 }).add()),
              h7(r.buttons, (t, a) => {
                let n = { padding: (t = h4(r.buttonOptions, t)).padding };
                !i.styledMode &&
                  t.theme &&
                  (h8(n, t.theme), (n.style = h4(t.theme.style, t.style)));
                let { text: l, width: h = 0, height: d = 0, padding: c = 0 } = t,
                  p = i.renderer
                    .button(
                      ('+' !== l && '-' !== l && l) || '',
                      0,
                    ...
                    .attr({ width: h, height: d, title: i.options.lang[a], zIndex: 5 })
                ...
                if ('+' === l || '-' === l) {
                  ...
                  ('+' === l && s.push(['M', c + e / 2, c + 3], ['L', c + e / 2, c + d - 3]),
                    i.renderer
                      .path(s)
              ...
              h9(i, 'render', function () {
                ...
                if (s) {
                  ...
                  if (t(s, i)) {
                    ...
                    e.navButtonsGroup.attr({ translateY: 'bottom' === a ? t : o });
                  }
                }
              });
          }
          ...
          this.moveToTopOnHover &&
            ...
            t?.state === 'hover'
              ? (this.graphic.attr({ id: this.id }),
                e.stateMarkerGraphic.attr({ href: `${i.url}#${this.id}`, visibility: 'visible' }))
        ...
        update(t) {
          (t.chart &&
            ...
            this.mapView?.recommendMapView(
              this,
              [t.chart.map, ...(this.options.series || []).map(t => t.mapData)],
              !0,
            ),
      ...
      class dM extends dx {
        static getProjectedPath(t, e) {
          return (
            t.projectedPath ||
              (e && t.geometry
                ? ((e.hasCoordinates = !0), (t.projectedPath = e.path(t.geometry)))
      ...
      !(function (t) {
        ...
        function s(t, e) {
          ...
          return { x: ((g[0] - n) * a + l) * r + s, y: -(((h - g[1]) * a + d) * r - o) };
        }
        function o(t, e) {
          let i = this.options.chart.proj4 || dS.proj4;
          if (!i) {
          ...
          let {
            ...
            c = { x: ((t.x - s) / r - l) / a + n, y: ((t.y - o) / r + d) / a + h },
            p = e.cosAngle || (e.rotation && Math.cos(e.rotation)),
            u = e.sinAngle || (e.rotation && Math.sin(e.rotation)),
            g = i(
              e.crs,
              'WGS84',
              e.rotation ? { x: c.x * p + -(c.y * u), y: c.x * u + c.y * p } : c,
            );
        ...
        function r(t, e) {
          ...
          let i = t.objects[e];
          if (i['hc-decoded-geojson'] && i['hc-decoded-geojson'].title === t.title)
          ...
          if (t.transform) {
            ...
            for (let t = 0, l = r.length; t < l; ++t) {
              ...
              for (let t = 0, s = l.length; t < s; ++t)
                e.push([(i += l[t][0]) * a[0] + n[0], (o += l[t][1]) * a[1] + n[1]]);
            }
          }
          let o = t =>
              'number' == typeof t[0]
                ? t.reduce((t, e, i) => {
                    ...
                    return (
                      e < 0
                        ? (o = o.slice(0, 0 === i ? o.length : o.length - 1)).reverse()
                        : i && (o = o.slice(1)),
                      t.concat(o)
                    );
                  }, [])
          ...
          for (let t = 0, e = r.length; t < e; ++t)
            a.push({
              ...
              geometry: { type: r[t].type, coordinates: r[t].coordinates || o(r[t].arcs) },
            });
          let n = {
          ...
          (t.geojson = function (t, e = 'map', i) {
            ...
            for (let t = 0, i = a.length; t < i; ++t) {
              ...
              let o = a[t],
                ...
                h = o.properties;
              if (
                (('map' === e || 'mapbubble' === e) && ('Polygon' === n || 'MultiPolygon' === n)
                  ? l.length && (i = { geometry: { coordinates: l, type: n } })
                  : 'mapline' === e && ('LineString' === n || 'MultiLineString' === n)
                    ? l.length && (i = { geometry: { coordinates: l, type: n } })
                    : 'mappoint' === e &&
                      'Point' === n &&
                      l.length &&
            ...
            return (
              i &&
                o.copyrightShort &&
                ((i.chart.mapCredits = dT(i.chart.options.credits?.mapText, { geojson: o })),
      ...
      let dB = Math.sign || (t => (0 === t ? 0 : t > 0 ? 1 : -1)),
        ...
        dX = class {
          ...
          forward(t) {
            ...
            return [
              ...
              74.03120656864502 * i * (1.340264 + -0.081106 * s + o * (893e-6 + 0.003796 * s)),
            ];
          }
          inverse(t) {
            ...
            for (
              ...
              t < 12 &&
              ((a = (r = o * o) * r * r),
              (n = o * (1.340264 + -0.081106 * r + a * (893e-6 + 0.003796 * r)) - i),
              (o -= l =
                n /
                (1.340264 + -0.24331799999999998 * r + a * (0.0062510000000000005 + 0.034164 * r))),
              !(1e-9 > Math.abs(l)));
              ++t
            );
            a = (r = o * o) * r * r;
        ...
        dH = class {
          ...
          forward(t) {
            return [t[0] * dF * 63.78137, 79.7267125 * Math.log(Math.tan(dG + 0.4 * t[1] * dF))];
          }
          inverse(t) {
            return [
              t[0] / 63.78137 / dF,
        ...
        { clipLineString: d$, clipPolygon: d_ } = {
          clipLineString: function (t, e) {
            ...
            for (let t = 1; t < s.length; t++)
              (s[t].isIntersection && s[t - 1].isIntersection && (i.push(s.splice(0, t)), (t = 0)),
      ...
      class d2 {
        ...
        static insertGeodesics(t) {
          let e = t.length - 1;
          for (; e--; )
            if (Math.max(Math.abs(t[e][0] - t[e + 1][0]), Math.abs(t[e][1] - t[e + 1][1])) > 10) {
        ...
        constructor(t = {}) {
          ...
          (r && ((this.maxLatitude = r.maxLatitude || 90), (this.hasGeoProjection = !0)),
            a && r
              ? ((this.forward = t => r.forward(a.forward(t))),
                (this.inverse = t => a.inverse(r.inverse(t))))
              : r
                ? ((this.forward = t => r.forward(t)), (this.inverse = t => r.inverse(t)))
        ...
        lineIntersectsBounds(t) {
          let { x1: e, x2: i, y1: s, y2: o } = this.bounds || {},
            ...
            n = t[0];
          return (
            (a = r(t, 0, e)) ? ((n = a), (t[1] = a)) : (a = r(t, 0, i)) && ((n = a), (t[1] = a)),
          ...
          for (let i = 0, o = t.length; i < o; ++i) {
            ...
            if ((a < -90 || a > 90) && (n < -90 || n > 90) && a > 0 != n > 0) {
              let t = dq((180 - ((a + 360) % 360)) / (((n + 360) % 360) - ((a + 360) % 360)), 0, 1),
                e = r[1] + t * (o[1] - r[1]);
              s.push({ i, lat: e, direction: a < 0 ? 1 : -1, previousLonLat: r, lonLat: o });
            }
          }
          if (s.length) {
            if (e) {
              s.length % 2 == 1 &&
                ((i = s.slice().sort((t, e) => Math.abs(e.lat) - Math.abs(t.lat))[0]), dK(s, i));
              let e = s.length - 2;
              for (; e >= 0; ) {
                let i = s[e].i,
          ...
          let c = t => {
            let s = t.map(t => {
                if (l) {
                  h && (t = h.forward(t));
                  let e = t[0];
                  (1e-6 > Math.abs(e - 180) && (e = e < 180 ? 179.999999 : 180.000001),
                    (t = [e, t[1]]));
                }
                return t;
              }),
              o = [s];
            (n && (d2.insertGeodesics(s), l && (o = this.cutOnAntimeridian(s, a))),
              o.forEach(t => {
                let s, o;
                ...
                let h = !1,
                  ...
                  m = t.map(t => {
                    ...
                    return (
                      e.outside ? (u = !0) : (g = !0),
                      e[1] === 1 / 0 ? (e[1] = 1e10) : e[1] === -1 / 0 && (e[1] = -1e10),
                      e
                    );
                  });
                if (l) {
                  ...
                  for (let e = 0; e < m.length; e++) {
                    ...
                    r.outside
                      ...
                      : (a && !s && ((s = i), t.push(i), m.push(r)),
                        c &&
                          o &&
                          (a && n ? d2.geodesic(o, i).forEach(t => p(d.forward(t))) : (h = !1)),
                        p(r),
                        (o = i),
                        (c = !1));
                  }
          ...
          return (
            'LineString' === t.type
              ...
              : 'MultiLineString' === t.type
                ...
                : 'Polygon' === t.type
                  ? (t.coordinates.forEach(t => c(t)), r.length && r.push(['Z']))
                  : 'MultiPolygon' === t.type &&
      ...
      function cd(t, e) {
        ...
        return (
          Math.log(400.979322 / Math.max((t.x2 - t.x1) / (i / 256), (t.y2 - t.y1) / (s / 256))) /
          Math.log(2)
        );
      }
      function cc(t) {
      ...
      class cp {
              ...
              d8(t, 'afterSetChartSize', () => {
                ((this.playingField = this.getField()),
                  (void 0 === this.minZoom || this.minZoom === this.zoom) &&
                    ...
                    this.userOptions.center && cr(!0, this.center, this.userOptions.center)));
              }),
            ),
            this.setUpEvents());
        }
        ...
        recommendMapView(t, e, i = !1) {
          ...
          (ct(this, 'onRecommendMapView', { geoBounds: r, chart: t }, function () {
        ...
        setView(t, e, i = !0, s) {
          (t && (this.center = t),
            'number' == typeof e &&
              ('number' == typeof this.minZoom && (e = Math.max(e, this.minZoom)),
              'number' == typeof this.options.maxZoom && (e = Math.min(e, this.options.maxZoom)),
              ci(e) && (this.zoom = e)));
            ...
            if (!this.chart.series.some(t => t.isDrilling)) {
              ...
              (c - o < s
                ...
                : o < e && c < e + s
                  ...
                  : c > e + s && o > e && (t[0] += Math.min(c - s - e, o - e) / a),
                p - d < r
                  ? (t[1] = h[1])
                  : d < i && p < i + r
                    ? (t[1] -= Math.max(d - i, p - r - i) / a)
                    : p > i + r && d > i && (t[1] -= Math.min(p - r - i, d - i) / a),
            ...
            o = o => {
              ...
              if (
                (a?.length === 1
                  ...
                  : a?.length === 2 &&
                    ((h = (a[0].chartX + a[1].chartX) / 2), (d = (a[0].chartY + a[1].chartY) / 2)),
                l?.length === 2 &&
                  r &&
                  (c =
                    Math.log(
                ...
                (l?.length === 2 &&
                  ((a = (l[0].chartX + l[1].chartX) / 2), (p = (l[0].chartY + l[1].chartY) / 2)),
                  r !== e &&
                    ((e = r),
                    (t = this.projection.forward(this.center)),
                    (i = (this.projection.options.rotation || [0, 0]).slice())));
            ...
            d8(s, 'selection', t => {
              if (t.resetSelection) this.zoomBy();
                ...
                let e = t.x - s.plotLeft,
                  ...
                  { y: a, x: n } = this.pixelsToProjectedUnits({ x: e + t.width, y: i + t.height });
                (this.fitToBounds(
                  { x1: r, y1: o, x2: n, y2: a },
                  void 0,
                  !0,
        ...
        update(t, e = !0, i) {
          ...
          (cr(!0, this.userOptions, t),
            cr(!0, this.options, t),
            'insets' in t &&
              (this.insets.forEach(t => t.destroy()), (this.insets.length = 0), (r = !0)),
            (o || 'fitToGeometry' in t) && delete this.fitToGeometryCache,
            (o || r) &&
              (this.chart.series.forEach(t => {
                let e = t.transformGroups;
                if (
                  (t.clearBounds && t.clearBounds(), (t.isDirty = !0), (t.isDirtyData = !0), r && e)
                )
                  for (; e.length > 1; ) {
                    let t = e.pop();
                    t && t.destroy();
        ...
        constructor(t, e) {
          if (
            ...
            ((this.geoBoundsProjectedBox = d9(e)),
              (this.geoBoundsProjectedPolygon = e.map(t => [t[1] || 0, t[2] || 0])));
          }
        }
        getField(t = !0) {
          let e = this.hitZone;
          if (e) {
            ...
            if (ci(a) && ci(l)) return { x: a, y: l, width: n - a, height: h - l };
          }
        ...
        render() {
          ...
          if (s && e.group) {
            ...
            (this.border ||
              ...
              (o = !1)),
              t.styledMode ||
                this.border.attr({ stroke: i.borderColor, 'stroke-width': i.borderWidth }));
      ...
      class cI extends cb {
        ...
        animate(t) {
          ...
          t
            ...
            : i.animate({ translateX: e.plotLeft, translateY: e.plotTop, scaleX: 1, scaleY: 1 }, s);
        }
        clearBounds() {
          (this.points.forEach(t => {
        ...
        drawPoints() {
          ...
          if (o) {
            ...
            (this.doFullTranslate() &&
              (this.points.forEach(t => {
                let { graphic: e } = t;
                ((t.group = s['number' == typeof t.insetIndex ? t.insetIndex + 1 : 0]),
              ...
              this.points.forEach(i => {
                ...
                if (s) {
                  let o = s.animate,
                    r = '';
                  (i.name && (r += 'UX4Gmap-name-' + i.name.replace(/ /g, '-').toLowerCase()),
                    i.properties &&
                      i.properties['hc-key'] &&
                      (r += ' UX4Gmap-key-' + i.properties['hc-key'].toString().toLowerCase()),
                    r && s.addClass(r),
                    e.styledMode && s.css(this.pointAttribs(i, (i.selected && 'select') || void 0)),
                    s.attr({
                  ...
                  if (i) {
                    ...
                    if (t && cC(e) && cC(o)) {
                      ...
                      r &&
                        ...
                        (i = s.getProjectedBounds(r.projection)) && r.allBounds.push(i),
        ...
        processData() {
          ...
          (u &&
            cL(u, t => {
              t.rotation &&
                ((t.cosAngle = Math.cos(t.rotation)), (t.sinAngle = Math.sin(t.rotation)));
            }),
            cS(s.mapData)
              ? (i = s.mapData)
              : p &&
                'FeatureCollection' === p.type &&
                ((this.mapTitle = p.title), (i = A.geojson(p, this.type, this))),
            (this.processedData = []));
          ...
          if (i) {
            ...
            if (s.allAreas) {
              ...
              let t =
                ...
                '|';
              i.forEach(e => {
                (n[0] && -1 !== t.indexOf('|' + e[n[0]] + '|')) || g.push(cP(e, { value: null }));
              });
            }
          }
        ...
        setOptions(t) {
          ...
          return (
            null === e.joinBy && (i = '_i'),
            i && ((this.joinBy = cE(i)), this.joinBy[1] || (this.joinBy[1] = this.joinBy[0])),
            e
          );
        }
        translate() {
          ...
          if (
            (this.chart.hasRendered &&
              ...
              this.generatePoints(),
              delete this.bounds,
              !e || e.userOptions.center || cC(e.userOptions.zoom) || e.zoom !== e.minZoom
            ...
            this.points.forEach(o => {
              ...
              (r &&
                ...
                t && ((o.shapeType = 'path'), (o.shapeArgs = { d: dM.getProjectedPath(o, i) })),
                o.hiddenInDataClass ||
          ...
          if (
            ...
            this.points.forEach(s => {
              let o,
                ...
                l =
                  this.projectPoint(s.options) || (s.properties && this.projectPoint(s.properties));
              if (
                (l
                  ? ((r = l.x), (a = l.y))
                  : s.bounds &&
      ...
      let c$ = {
        ...
        { parse: c_ } = tA,
        { noop: cq } = A,
        { arrayMax: cK, arrayMin: cJ, isNumber: cQ, merge: c0, pick: c1, stableSort: c2 } = J,
        c3 = class {
          constructor(t, e) {
          ...
          setOptions() {
            ...
            t.forEach(function (h, d) {
              (l ||
                ...
                l ||
                  c0(!0, t[d], { bubbleAttribs: c0(o), connectorAttribs: c0(r), labelAttribs: a }));
            }, this);
          }
          getRangeRadius(t) {
            let e = this.options,
          ...
          render() {
            ...
            (t.label = e.g('bubble-legend-item').css(this.legend.itemStyle || {})),
          ...
          renderRange(t) {
            let e = this.ranges[0],
              ...
              M = g || 'left' === u ? -p : p;
            ('center' === u &&
              ((M = 0), (s.connectorDistance = 0), (t.labelAttribs.align = 'center')),
              l.bubbleItems.push(
                n
                  .circle(x, d + b, c)
              ...
              l.connectors.push(
                n
                  ...
                  .addClass(
                    (v ? 'UX4Gmap-color-' + this.options.seriesIndex + ' ' : '') +
            ...
            let w = n
                ...
                .css(v ? {} : o.style)
                .addClass('UX4Gmap-bubble-legend-labels ' + (s.labels.className || ''))
                .add(this.legendItem.symbol),
              k = { x: x + M + s.labels.x, y: y + s.labels.y + 0.4 * w.getBBox().height };
          ...
          getRanges() {
            ...
            return (
                ...
                t.isBubble &&
                  ...
                  ((r = c1(
                    ...
                    Math.min(
                      ...
                      Math.max(
                        cJ(o),
                        !1 === t.options.displayNegative ? t.options.zThreshold : -Number.MAX_VALUE,
                      ),
                    ),
                  )),
              ...
              (s =
                r === a
                  ? [{ value: a }]
                  : [{ value: r }, { value: (r + a) / 2 }, { value: a, autoRanges: !0 }]),
      ...
      function pt(t, e, i) {
        ...
        let a = this.legend,
          n = pe(this) >= 0;
        a && a.options.enabled && a.bubbleLegend && a.options.bubbleLegend.autoRanges && n
          ? ((s = a.bubbleLegend.options),
            ...
            pr(a, pi(a)))
          : (t.call(this, e, i),
            a && a.options.enabled && a.bubbleLegend && (a.render(), pr(a, pi(a))));
      }
      function pe(t) {
        let e = t.series,
          i = 0;
      ...
      function ps(t) {
        ...
        (e &&
          e.ranges &&
          e.ranges.length &&
          (s.ranges.length && (s.autoRanges = !!s.ranges[0].autoRanges), this.destroyItem(e)),
          o >= 0 &&
            i.enabled &&
            s.enabled &&
            ((s.seriesIndex = o),
      ...
      function po(t) {
        ...
        this &&
          ...
          this.bubbleLegend.visible !== e &&
            (this.update({ bubbleLegend: { enabled: e } }), (this.bubbleLegend.visible = e)),
          (i.visible = o));
      }
      function pr(t, e) {
        let i = t.allItems,
        ...
        i.forEach((t, i) => {
          (n = t.legendItem || {}).group &&
            ...
            ((a = t.movementX) || (s && t.ranges)) &&
              ((a = s ? o - t.options.maxSize / 2 : o + a), n.group.attr({ translateX: a })),
            i > e[l].step && l++,
        ...
        ('xAxis' === e || 'yAxis' === e) &&
          (this.series.forEach(t => {
            if (t.bubblePadding && t.reserveSpace()) {
              ...
              if (
                (i &&
                  ((t.onPoint || t).getRadii(0, 0, t), t.onPoint && (t.radii = t.onPoint.radii)),
                o > 0)
              ) {
                let i = e.length;
                for (; i--; )
      ...
      function pA() {
        let { ticks: t, tickPositions: e, dataMin: i = 0, dataMax: s = 0, categories: o } = this,
          r = this.options.type;
      ...
      class pP extends pf {
        static compose(t, e, i) {
          (pa.compose(e, i),
            pT(pp, 'Series.Bubble') && (px(t, 'foundExtremes', pC), px(t, 'afterRender', pA)));
        }
        animate(t) {
          !t &&
            ...
            this.points.forEach(function (t) {
              ...
              e &&
                e.width &&
                (this.hasRendered || e.attr({ x: i, y: s, width: 1, height: 1 }),
        ...
        getRadii() {
          ...
          for (o = 0, s = t.length; o < s; o++)
            ((r = t[o]), i.push(this.getRadius(a.zMin, a.zMax, n, l, r, e && e[o])));
          this.radii = i;
        }
          ...
          if (pw(o)) {
            if (
              (a.sizeByAbsoluteValue &&
                ((o = Math.abs(o - l)), (e = h = Math.max(e - l, Math.abs(t - l))), (t = 0)),
              o < t)
            )
              return i / 2 - 1;
            h > 0 && (d = (o - t) / h);
        ...
        translateBubble() {
          ...
          for (; o--; ) {
            let r = t[o],
              a = i ? i[o] : 0;
            ('z' === this.zoneAxis && (r.negative = (r.z || 0) < (e.zThreshold || 0)),
              pw(a) && a >= s / 2
                ? ((r.marker = pM(r.marker, { radius: a, width: 2 * a, height: 2 * a })),
                  (r.dlBox = { x: r.plotX - a, y: r.plotY - a, width: 2 * a, height: 2 * a }))
        ...
        getPxExtremes() {
          let t = Math.min(this.chart.plotWidth, this.chart.plotHeight),
            e = e => {
              let i;
              return (
                'string' == typeof e && ((i = /%$/.test(e)), (e = parseInt(e, 10))),
                i ? (t * e) / 100 : e
              );
            },
        ...
        getZExtremes() {
          ...
          if (e.length) {
            let i = pS(
                ...
                pv(
                  pb(e),
                  !1 === t.displayNegative ? t.zThreshold || 0 : -Number.MAX_VALUE,
                  Number.MAX_VALUE,
                ),
              ),
              s = pS(t.zMax, py(e));
        ...
        searchKDTree(t, e, i, s = pu, o = pu) {
          return (
            (s = (t, e, i) => {
              ...
              return (
                s < 0 && o < 0
                  ? ((r = s - (t.marker?.radius || 0) >= o - (e.marker?.radius || 0) ? t : e),
                    (a = !0))
                  : (r = s < o ? t : e),
                [r, a]
              );
      ...
      class pR extends pL {
        ...
        searchPoint(t, e) {
          return this.searchKDTree(
            { plotX: t.chartX - this.chart.plotLeft, plotY: t.chartY - this.chart.plotTop },
            e,
            t,
          );
        }
      ...
      pG(pH.prototype, { dataLabelOnNull: !0, moveToTopOnHover: !0, ttBelow: !1 });
      let { isNumber: pY } = J,
        { doc: pV } = A,
        ...
        { addEvent: pJ, extend: pQ, fireEvent: p0, isNumber: p1, merge: p2, pick: p3 } = J,
          ...
          getContext: function (t) {
            ...
            return e && i
              ...
              : ((t.canvas = pV.createElement('canvas')),
                (t.context = t.canvas.getContext('2d', { willReadFrequently: !0 }) || void 0),
                t.context);
          },
        };
      class p9 extends pq {
        ...
        drawPoints() {
          ...
          if (i) {
              ...
              if (l && a && g) {
                let { min: g, max: m } = s.getExtremes(),
                  ...
                  [w, k] = [
                    [v, v / y, r, 'ceil'],
                    [M, M / b, !n, 'floor'],
                  ].map(([t, e, i, s]) => (i ? i => Math[s](t - e * i) : t => Math[s](e * t))),
                  S = (l.width = v + 1),
                  T = S * (l.height = M + 1),
                  C = (u - 1) / T,
            ...
            (s.enabled || t._hasPointMarkers) &&
              ...
              t.points.forEach(e => {
                e.graphic &&
                  (e.graphic[t.chart.styledMode ? 'css' : 'animate'](t.colorAttribs(e)),
        ...
        translate() {
          ...
          for (let e of (this.generatePoints(), this.points)) {
            ...
            if (
              ((e.hasImage = 0 === ((e.marker && e.marker.symbol) || i || '').indexOf('url')), o)
            ) {
              let t = Math.abs(l - h);
